...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text(lang.tr('btn_cancel'), style: const TextStyle(color: Color(0xFF7C8A7C))),
          ),
          FilledButton(
            onPressed: () {
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(
            ...
            child: Text(lang.tr('btn_delete'), style: const TextStyle(color: Colors.white)),
          ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    final goals = [
      {'key': 'Strength', 'label': lang.tr('goal_strength'), 'icon': Icons.fitness_center},
      {'key': 'Hypertrophy', 'label': lang.tr('goal_hypertrophy'), 'icon': Icons.accessibility_new},
      {'key': 'Fat Loss', 'label': lang.tr('goal_fatloss'), 'icon': Icons.local_fire_department},
      {'key': 'Fitness', 'label': lang.tr('goal_fitness'), 'icon': Icons.favorite_border},
    ];
            ...
            children: [
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixIcon: Icon(Icons.height, color: textMuted),
                              ),
                            ),
                          ),
                          const SizedBox(width: 16),
                      ...
                      FilledButton.icon(
                        ...
                        label: Text(lang == AppLanguage.th ? 'บันทึกข้อมูลร่างกาย' : 'Save Body Metrics'),
                      ),
                    ],
                  ),
                ),
                    ...
                    children: [
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 11,
                                    color: !isLbs ? (themeMode == ThemeMode.dark ? Colors.black : Colors.white) : textMuted,
                                  ),
                                ),
                              ),
                            ),
                      ...
                      ListTile(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            GestureDetector(
                              onTap: lang != AppLanguage.th ? () => ref.read(languageProvider.notifier).setLanguage(AppLanguage.th) : null,
                              child: Container(
                                padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                                decoration: BoxDecoration(
                                  color: lang == AppLanguage.th ? accent : Colors.transparent,
                                  borderRadius: BorderRadius.circular(6),
                                  border: lang == AppLanguage.th ? null : Border.all(color: border),
                                ),
                                child: Text(
                                  'TH',
                                  style: TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 11,
                                    color: lang == AppLanguage.th ? (themeMode == ThemeMode.dark ? Colors.black : Colors.white) : textMuted,
                                  ),
                                ),
                              ),
                            ),
                            const SizedBox(width: 6),
                            GestureDetector(
                              onTap: lang != AppLanguage.en ? () => ref.read(languageProvider.notifier).setLanguage(AppLanguage.en) : null,
                              child: Container(
                                padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                                decoration: BoxDecoration(
                                  color: lang == AppLanguage.en ? accent : Colors.transparent,
                                  borderRadius: BorderRadius.circular(6),
                                  border: lang == AppLanguage.en ? null : Border.all(color: border),
                                ),
                                child: Text(
                                  'EN',
                                  style: TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 11,
                                    color: lang == AppLanguage.en ? (themeMode == ThemeMode.dark ? Colors.black : Colors.white) : textMuted,
                                  ),
                                ),
                              ),
                            ),
                      ...
                      ListTile(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            GestureDetector(
                              onTap: themeMode != ThemeMode.light ? () => ref.read(themeProvider.notifier).setThemeMode(ThemeMode.light) : null,
                              child: Container(
                                padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                                decoration: BoxDecoration(
                                  color: themeMode == ThemeMode.light ? accent : Colors.transparent,
                                  borderRadius: BorderRadius.circular(6),
                                  border: themeMode == ThemeMode.light ? null : Border.all(color: border),
                                ),
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 11,
                                    color: themeMode == ThemeMode.light ? (themeMode == ThemeMode.dark ? Colors.black : Colors.white) : textMuted,
                                  ),
                                ),
                              ),
                            ),
                            const SizedBox(width: 6),
                            GestureDetector(
                              onTap: themeMode != ThemeMode.dark ? () => ref.read(themeProvider.notifier).setThemeMode(ThemeMode.dark) : null,
                              child: Container(
                                padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                                decoration: BoxDecoration(
                                  color: themeMode == ThemeMode.dark ? accent : Colors.transparent,
                                  borderRadius: BorderRadius.circular(6),
                                  border: themeMode == ThemeMode.dark ? null : Border.all(color: border),
                                ),
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 11,
                                    color: themeMode == ThemeMode.dark ? (themeMode == ThemeMode.dark ? Colors.black : Colors.white) : textMuted,
                                  ),
                                ),
                              ),
                            ),
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        title: Text(lang.tr('feedback_title'), style: const TextStyle(fontSize: 14)),
                      ...
                      ListTile(
                        ...
                        title: Text(lang.tr('app_version'), style: const TextStyle(fontSize: 14)),
                        trailing: const Text(
                          'v1.0.0',
              ...
              Card(
                ...
                shape: RoundedRectangleBorder(
                  ...
                  side: BorderSide(color: themeMode == ThemeMode.dark ? const Color(0xFF3E1F1F) : const Color(0xFFFFD3D3)),
                ),
                child: Padding(
                  padding: const EdgeInsets.symmetric(vertical: 8.0),
                  child: Column(
                    children: [
                      ...
                      Divider(color: themeMode == ThemeMode.dark ? const Color(0xFF3E1F1F) : const Color(0xFFFFD3D3)),
                      ListTile(
